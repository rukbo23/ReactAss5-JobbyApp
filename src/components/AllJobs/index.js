...
class AllJobs extends Component {
    ...
    onGetProfileDetails = async () =>{
        ...
        const profileApoUrl= 'https://apis.ccbp.in/profile'
    ...
    onGetJobDetails = async () =>{
        ...
        if (responseProfile.ok === true) {
            ...
            const updatedDataJobs = fetchedDataJobs.jobs.map(eachItem => ({
                ...
                packagePerAnnum: eachItem.packagePerAnnum,
    ...
    onGetJobsView = () =>{
        ...
        return noJobs ? (
            <div className="no-jobs-container">
                ...
                />
                <h1>No jobs found</h1>
                <p>We could not fine any jobs. Try other filters.</p>
            </div>
        ): (
                ...
                <div className="all-jobs-container">
                    ...
                    <div className="jobs-container">
                        <div>
                            ...
                            >
                                <AiOutlineSarech className="search-icon"/>
                            </button>
                        </div>
