...
class JobItemDetails extends Component {
  ...
  getFormattedData = data => ({
    ...
    skills: data.skilss.map(eachSkill => ({
  ...
  getJobData = async () =>{
      ...
      const url =`http://apis.ccbp.in/jobs/${id}`
      const options = {
          headers: {
      ...
      if (response.ok === true) {
          ...
          const this.updatedSimilarJobsData = data.similar_jobs.map(eachSimilarJob =>
        ...
        this.setState({
            jobData: updatedData,
            similarJobsData: this.updatedSimilarJobsData,
...
renderLoadingView =() =>{
    <div className="job-item-loader-container" data-tested="loader">
                    ...
                    <div className="location-package-container">
                        <div className="location-employee-container">
                            ...
                            <div className="employee-type-container">
                                ...
                                <p className="employee-heading">{employment}</p>
                            </div>
                        </div>
